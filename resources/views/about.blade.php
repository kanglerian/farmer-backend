...
<body class="antialiased bg-gray-50">
    <section class="flex flex-col items-center justify-between h-screen">
        ...
        <div class="w-full max-w-7xl mx-auto h-full mt-10 text-center">
            <div class="space-y-4">
                <h2 class="font-bold text-2xl">Tentang Kami</h2>
                <p>Selamat datang di SIPETANI, Sistem Informasi Petani inovatif yang dirancang khusus untuk mendukung para petani di Banjar, Lakbok, Jawa Barat. SIPETANI merupakan aplikasi web yang berfokus pada pelayanan publik dengan menghadirkan solusi teknologi modern dalam pengelolaan lahan pertanian. Melalui sistem ini, para petani dapat mengendalikan penyiraman sawah secara otomatis berbasis IoT (Internet of Things), memastikan penggunaan air yang efisien dan tepat waktu. Dengan SIPETANI, kami berkomitmen untuk meningkatkan produktivitas dan kesejahteraan petani melalui teknologi yang mudah diakses dan ramah pengguna. Bergabunglah dengan kami dalam memanfaatkan teknologi untuk masa depan pertanian yang lebih baik.</p>
            </div>
        </div>
    </section>
