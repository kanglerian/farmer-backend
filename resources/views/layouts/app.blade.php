...
<body class="font-sans antialiased">
    <div class="min-h-screen bg-gray-100">
        <main class="flex h-screen">
            <aside id="aside"
                class="hidden w-7/12 md:w-2/12 bg-[#2c3e50] h-full md:flex flex-col flex-shrink-0 font-normal fixed md:static z-50 lg:flex">
                <div class="relative flex flex-col flex-1 h-full pt-0 bg-white border-r border-gray-200">
                        ...
                        <div class="flex-1 px-3 space-y-1 bg-white divide-y divide-gray-200">
                            <ul class="pb-2 space-y-2">
                                <li>
                                    <a href="{{ route('dashboard') }}"
                                        class="flex items-center p-2 text-base text-gray-500 rounded-lg hover:bg-gray-100 group">
                            ...
                            <div class="pt-2 space-y-2">
                                <a href="https://github.com/themesberg/flowbite-admin-dashboard/issues" target="_blank"
                                    class="flex items-center p-2 text-base text-gray-500 transition duration-75 rounded-lg hover:bg-gray-100 group">
                                    <i class="fa-solid fa-life-ring"></i>
                                    <span class="ml-3">Support</span>
                                </a>
                                <button type="button" class="block md:hidden" onclick="sidebarToggle()">Kembali</button>
                            </div>
                        </div>
                    </div>
                    <div class="absolute bottom-0 left-0 justify-center hidden w-full p-4 space-x-4 bg-white lg:flex"
                        sidebar-bottom-menu>
                        <a href="#"
                            class="inline-flex justify-center p-2 text-gray-500 rounded cursor-pointer hover:text-gray-500 hover:bg-gray-100">
